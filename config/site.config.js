...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'corkine@c.mazhangjing.com',
  ...
  email: 'mailto:corkine@c.mazhangjing.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/corkine',
    },
    {
      name: 'Home',
      link: 'https://mazhangjing.com'
    }
  ],
